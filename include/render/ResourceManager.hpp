...
public:
	...
	static ma_sound* LoadSound(const char* file, std::string name, bool loopable);
	// retrieves a stored sound
	static ma_sound* GetSound(std::string name);
...
private:
	...
	static ma_sound* loadSoundFromFile(const char* file, bool loopeable);
};
